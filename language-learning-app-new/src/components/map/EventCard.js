...
export default function EventCard({ event, onClose, isAttending, onToggleAttendance }) {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.actions}>
        <TouchableOpacity 
          style={[styles.button, isAttending && styles.buttonActive]}
          onPress={() => onToggleAttendance(!isAttending)}
        >
          <Ionicons name="checkmark-circle" size={20} color={isAttending ? '#99f21c' : '#FFFFFF'} />
          <Text style={[styles.buttonText, isAttending && styles.buttonTextActive]}>
